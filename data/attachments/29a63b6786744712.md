...
```
Error: A snapshot doesn't exist at /home/runner/work/katalon-demo-cura/katalon-demo-cura/tests/VisualTest.spec.ts-snapshots/landing-page-firefox-linux.png, writing actual.
```
